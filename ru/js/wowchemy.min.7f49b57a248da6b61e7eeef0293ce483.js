(() => {
  ...
  (() => {
    ...
    var e = {authors: "Authors", event: "\u0412\u044B\u0441\u0442\u0443\u043F\u043B\u0435\u043D\u0438\u044F", post: "\u0421\u0442\u0430\u0442\u044C\u0438", project: "\u041F\u0440\u043E\u0435\u043A\u0442\u044B", publication: "\u041F\u0443\u0431\u043B\u0438\u043A\u0430\u0446\u0438\u0438", slides: "Slides"}, f = {no_results: "\u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442 \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D", placeholder: "\u041F\u043E\u0438\u0441\u043A ...", results: "\u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442 \u043D\u0430\u0439\u0434\u0435\u043D"}, c = {indexURI: "/ru/index.json", minLength: 1, threshold: 0.3}, d = {shouldSort: true, includeMatches: true, tokenize: true, threshold: c.threshold, location: 0, distance: 100, maxPatternLength: 32, minMatchCharLength: c.minLength, keys: [{name: "title", weight: 0.99}, {name: "summary", weight: 0.6}, {name: "authors", weight: 0.5}, {name: "content", weight: 0.2}, {name: "tags", weight: 0.5}, {name: "categories", weight: 0.5}]}, a = 60;
    function g(a2) {
  ...
  function switchTab() {
    var c = document.querySelectorAll("#donations_form > label"), f = document.getElementsByClassName("project-select")[0], g = f.options[f.selectedIndex], d = g.getAttribute("data-one-time"), i = g.getAttribute("data-recurring"), e = "position:relative!important;top:0px!important;margin-right:5px!important;margin-bottom:-1px!important;padding:12px 20px!important;font-weight:600!important;font-size:14px!important;line-height:18px!important;height:18px!important;text-align:center!important;border-left-width:1px!important;border-left-style:solid!important;border-left-color:#C6C6C6!important;border-right-width:1px!important;border-right-style:solid!important;border-right-color:#C6C6C6!important;border-top-width:1px!important;border-top-style:solid!important;border-top-color:#C6C6C6!important;border-top-left-radius:10px!important;border-top-right-radius:10px!important;background-color:white!important;background:-moz-linear-gradient(0deg, white 0%, white 90%, #f4ebb9 90%, #f4ebb9 100%)!important;background: -webkit-linear-gradient(0deg, white 0%, white 90%, #f4ebb9 90%, #f4ebb9 100%)!important;background: linear-gradient(0deg, white 0%, white 90%, #f4ebb9 90%, #f4ebb9 100%)!important;float: none!important;box-sizing: content-box!important;display: inline-block!important;", j = "position:relative!important;top:1px!important;margin-right:5px!important;margin-bottom: 0px!important;padding:12px 20px!important;font-weight:600!important;font-size:14px!important;line-height:14px!important;height:14px!important;text-align:center!important;border-left-width:1px!important;border-left-style:solid!important;border-left-color:#C6C6C6!important;border-right-width:1px!important;border-right-style:solid!important;border-right-color:#C6C6C6!important;border-top-width:1px!important;border-top-style:solid!important;border-top-color:#C6C6C6!important;border-top-left-radius:10px!important;border-top-right-radius:10px!important;background-color:#E3E3E3!important;background-image:none!important;background-repeat:repeat!important;background-position:top left!important;background-attachment:scroll!important;float: none!important;box-sizing: content-box!important;display:inline-block!important", b, a, h;
    if (d != null && i != null)
      for (b = 0; b < c.length; b++)
        a = c[b], h = document.getElementById(a.htmlFor + "_content"), document.getElementById(a.htmlFor).checked ? (a.style = e, showElement(h, "block")) : (a.style = j, hideElement(h));
    else
      hideTabs(d, e);
  }
  function hideTabs(b, a) {
    b == null ? (document.getElementById("mkdf.recurring").style = a, showElement(document.getElementById("donations_tabs_2_content"), "block"), hideElement(document.getElementById("mkdf.one.time")), hideElement(document.getElementById("donations_tabs_1_content"))) : (document.getElementById("mkdf.one.time").style = a, showElement(document.getElementById("donations_tabs_1_content"), "block"), hideElement(document.getElementById("mkdf.recurring")), hideElement(document.getElementById("donations_tabs_2_content")));
  }
  ...
  function showElement(a, b) {
    a.style.setProperty("display", b, "important");
  }
})();
